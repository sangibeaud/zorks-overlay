#/usr/portage/media-sound/linuxsampler/linuxsampler-2.1.1.ebuild
...
SLOT="0"
KEYWORDS="amd64 ~x86"
IUSE="alsa doc jack lv2 sf2 sqlite vst"
...
src_configure() {
	local myeconfargs=(
		...
		$(use_enable vst 'vstsdk-dir=/usr/local/include/VST_SDK')
	)
	econf "${myeconfargs[@]}"
}
